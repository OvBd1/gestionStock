...
function getArticle($id = null, $searchData = []) {
  if (!empty($id)) {
    ...
    if (!empty($date_fabrication)) $search .= " AND DATE(a.date_fabrication) LIKE '$date_fabrication'";
    if (!empty($date_expiration)) $search .= " AND DATE(a.date_expiration) LIKE '$date_expiration'";
